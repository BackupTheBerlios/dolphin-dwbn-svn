...
ContentBlockHead("Uploaded (and yet not approved) background images:");
...
//"
	...
	if( 0 < mysql_num_rows($result) )
	{
		...
		$ret .= '<div style="float:left;margin-right:5px;margin-top:5px;border: solid 1px #9b9a9a;background-color: #edecec;">
			...
			<div style="position:relative; text-align:center; background-color:#FFFFFF; line-height:20px; vertical-align:middle;"><a href="' . $site['url'] . 'profile.php?ID=' . $arr['IDMember'] . '" target="_blank">View Profile</a> |<a href="' . $site['url'] . 'profile_edit.php?ID=' . $arr['IDMember'] . '" target="_blank">Edit Profile<a></div>
			</div>';
