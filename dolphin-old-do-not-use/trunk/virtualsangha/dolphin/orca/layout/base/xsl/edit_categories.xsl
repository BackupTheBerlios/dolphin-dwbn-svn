...
<xsl:template match="page">
    ...
    <div class="f_buttons">
		<div class="f_buttons" style="top:1px;">
			<div title="[L[new group]]" class="btn" onmouseover="this.style.backgroundPosition='0 25px'" onmouseout="this.style.backgroundPosition='0 0'">
...
<xsl:template match="categ">		
	...
	<xsl:element name="ul">
		...
		<li class="tbl_c_forum">
            ...
            <a href="javascript:void(0);" onclick="return orca_admin.selectCat('{@uri}', 'cat{@id}');"><xsl:value-of select="title" disable-output-escaping="yes" /></a>
			...
			<div style="position:absolute; right:8px; top:13px; width:180px;">			
				...
				<div title="[L[move up]]" class="icn" onmouseover="this.style.backgroundPosition='0 24px'" onmouseout="this.style.backgroundPosition='0 0'" >
				...
				<div title="[L[move down]]" class="icn" onmouseover="this.style.backgroundPosition='0 24px'" onmouseout="this.style.backgroundPosition='0 0'" >
