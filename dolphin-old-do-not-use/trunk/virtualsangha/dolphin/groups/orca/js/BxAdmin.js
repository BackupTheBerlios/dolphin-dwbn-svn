...
Admin.prototype.delForum = function (forum_id)
{
	...
	{		
		var o = new BxXmlRequest('','','');			
		var cat_uri = o.getRetNodeValue (r, 'cat_uri');
        var cat_id = o.getRetNodeValue (r, 'cat_id');
		if (cat_id > 0)
		{
 ...
 */
Admin.prototype.editForumSubmit = function (cat_id, cat_uri, forum_id, title, desc, type)
{
	var $this = this;
...
Admin.prototype.compileLangs = function (sLang)
{
    ...
    new BxXmlRequest (this._base + "?action=compile_langs&lang=" + sLang + "&ts=" + (new Date()), h, true);
}
