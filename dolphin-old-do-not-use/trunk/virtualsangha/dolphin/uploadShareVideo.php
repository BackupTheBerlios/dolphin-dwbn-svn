...
$check_res = checkAction( $member['ID'], ACTION_ID_UPLOAD_GALLERY_VIDEO );
...
function PageMainCode()
{
	...
	$sCode .= '<div id="uploadForm" style="text-align: center;display:none;">'.getApplicationContent('movie','editor',array('id' => $member['ID'],'password'=>$member['Password']),true).'</div>';
