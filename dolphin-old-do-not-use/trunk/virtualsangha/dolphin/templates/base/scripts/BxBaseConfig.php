...
*/
	...
	var $bFreeMode, $bEnableCustomization, $bEnableGallery, $bEnablePoll, $bEnableIm, $bEnableComments, $bEnableGuestbook, $bEnableBlog, $bAnonymousMode;
	
	var $customize;
	
	function BxBaseConfig($site)
	{
		global $enable_blog, $anon_mode;
