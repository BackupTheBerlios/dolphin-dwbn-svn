                ...
                <div class="topMemberBlock">
                        ...
                        <div class="hello_actions">
                                ...
                                <span><a href="javascript:void(0);"
                                  onclick="window.open( 'presence_pop.php' , 'Presence', 'width=224,height=600,toolbar=0,directories=0,menubar=0,status=0,location=0,scrollbars=0,resizable=1');"
                ...
                <div class="topMemberBlock">
						<div class="thumbnail_block" style="float:right;position:relative;">
	                        <img style="width: 45px; height: 45px; background-image: url(<?= getTemplateIcon( 'man_small.gif' ) ?>);"
							  src="<?= getTemplateIcon( 'spacer.gif' ) ?>" />
						</div>
                        <div class="hello_member"><?= _t( '_Hello member', 'admin' ) ?></div>

                        <div class="hello_actions">
                                <span><a href="<?= $site['url'] ?>admin/index.php"><?= _t('_Admin Panel') ?></a></span>
        ...
        else
        {
                ...
                <div class="topMemberBlock">
                        <div class="no_hello_actions">
                                <a href="<?= $site['url'] ?>join_form.php"><?= _t( '_Join Now Top' ) ?></a>
        ...
        ?>
                <table class="MsgBox" cellpadding="0" cellspacing="0">
                        <tr>
                                ...
                                <td class="top_side"><img src="<?= getTemplateIcon( 'spacer.gif' ) ?>" /></td>
                                <td class="corder"><img src="<?= "{$site['url']}templates/tmpl_$tmpl/images/msgbox_cor_rt.png" ?>" /></td>
                        </tr>
                        <tr>
                                <td class="left_side"><img src="<?= getTemplateIcon( 'spacer.gif' ) ?>" /></td>
                                <td class="msgbox_content"><div class="msgbox_text"><?= $text ?></div></td>
                                <td class="right_side"><img src="<?= getTemplateIcon( 'spacer.gif' ) ?>" /></td>
                        </tr>
                        <tr>
                                <td class="corner"><img src="<?= "{$site['url']}templates/tmpl_$tmpl/images/msgbox_cor_lb.png" ?>" /></td>
                                <td class="bottom_side"><img src="<?= getTemplateIcon( 'spacer.gif' ) ?>" /></td>
