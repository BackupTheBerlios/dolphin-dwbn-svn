...
/**
 * PreForumVoteId generated by hbm2java
 */
@Embeddable
public class PreForumVoteId implements java.io.Serializable {

	private String userName;
	private int postId;

	public PreForumVoteId() {
	}

	public PreForumVoteId(String userName, int postId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PreForumVoteId))
			return false;
		PreForumVoteId castOther = (PreForumVoteId) other;
