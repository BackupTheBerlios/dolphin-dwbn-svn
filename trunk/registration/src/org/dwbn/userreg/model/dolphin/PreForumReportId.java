...
/**
 * PreForumReportId generated by hbm2java
 */
@Embeddable
public class PreForumReportId implements java.io.Serializable {

	private String userName;
	private int postId;

	public PreForumReportId() {
	}

	public PreForumReportId(String userName, int postId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PreForumReportId))
			return false;
		PreForumReportId castOther = (PreForumReportId) other;
