...
/**
 * GrpForumUser generated by hbm2java
 */
@Entity
@Table(name = "grp_forum_user", catalog = "dolphin", uniqueConstraints = @UniqueConstraint(columnNames = "user_email"))
public class GrpForumUser implements java.io.Serializable {
	...
	public GrpForumUser(String userName, String userPwd, String userEmail,
			int userJoinDate) {
