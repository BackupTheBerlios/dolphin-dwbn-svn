...
/**
 * GphotoRatingId generated by hbm2java
 */
@Embeddable
public class GphotoRatingId implements java.io.Serializable {

	private int galId;
	private int galRatingCount;
	private int galRatingSum;

	public GphotoRatingId() {
	}

	public GphotoRatingId(int galId, int galRatingCount, int galRatingSum) {
		this.galId = galId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GphotoRatingId))
			return false;
		GphotoRatingId castOther = (GphotoRatingId) other;
