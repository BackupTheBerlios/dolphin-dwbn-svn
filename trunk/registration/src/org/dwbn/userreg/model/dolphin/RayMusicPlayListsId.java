...
/**
 * RayMusicPlayListsId generated by hbm2java
 */
@Embeddable
public class RayMusicPlayListsId implements java.io.Serializable {

	private int fileId;
	private String owner;
	private byte order;

	public RayMusicPlayListsId() {
	}

	public RayMusicPlayListsId(int fileId, String owner, byte order) {
		this.fileId = fileId;
		this.owner = owner;
		this.order = order;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RayMusicPlayListsId))
			return false;
		RayMusicPlayListsId castOther = (RayMusicPlayListsId) other;
