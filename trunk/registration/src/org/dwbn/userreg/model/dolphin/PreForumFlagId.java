...
/**
 * PreForumFlagId generated by hbm2java
 */
@Embeddable
public class PreForumFlagId implements java.io.Serializable {

	private String user;
	private int topicId;

	public PreForumFlagId() {
	}

	public PreForumFlagId(String user, int topicId) {
		this.user = user;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PreForumFlagId))
			return false;
		PreForumFlagId castOther = (PreForumFlagId) other;
