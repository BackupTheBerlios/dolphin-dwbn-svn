...
?>
			<td class="<?= $membershipActive ? 'deactivate' : 'activate' ?>">
				<form name="formActivate<?= $ID ?>" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" style="margin: 0">
...
?>
			<td class="name">
				<a href="<?= $_SERVER['PHP_SELF'] ?>?edit=actions&edit_level=<?= $ID ?>">
...
?>
			<td class="pricing">
				<a href="<?= $_SERVER['PHP_SELF'] ?>?edit=pricing&edit_level=<?= $ID ?>">
					Pricing
				</a>
			</td>
			<td class="delete">
				<form name="formDelete<?= $ID ?>" action="<?= $_SERVER['PHP_SELF'] ?>" method="POST" style="margin: 0">
...
?>
	<div align="right">
		<form action="<?= $_SERVER['PHP_SELF'] ?>?edit=pricing&edit_level=<?= $membershipID ?>" method="POST">
...
?>
		<tr>
			...
			<td class="deleteCell">
				<form id="formDeletePaymentOption<?= $arrPaymentOption['Days'] ?>" action="<?= $_SERVER['PHP_SELF'] ?>?edit=pricing&edit_level=<?= $membershipID ?>" method="POST">
...
?>
	<div align="right">
		<form action="<?= $_SERVER['PHP_SELF'] ?>?edit=actions&edit_level=<?= $membershipID ?>" method="POST">
...
?>
	<div class="actionRowHeader">
		<table width="100%" style="height: 100%" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td>
					<form action="<?= $_SERVER['PHP_SELF'] ?>?edit=actions&edit_level=<?= $membershipID ?>" method="POST" style="padding:0; margin:0;">
	...
	<div class="actionRow" id="actionRow<?= $ID ?>">
		<form id="updateActionForm<?= $ID ?>" action="<?= $_SERVER['PHP_SELF'] ?>?edit=actions&edit_level=<?= $membershipID ?>" method="POST" style="padding:0; margin:0">
