...
function displayIndexPageSettings()
{
    ...
    <table width="100%" cellspacing="2" cellpadding="3" class="text">
		...
		<tr>
        	<td align="right" width="40%"> <?=getParamDesc("top_photos_max_num") ?>: </td>
            <td align="left">
            	<input type="text" class="no" name="top_photos_max_num" size="15" value="<?= htmlspecialchars(getParam('top_photos_max_num')) ?>" />
            </td>
        </tr>
    </table>
    <br>
