...
$site['email']             = $configuration->siteEmail();
$site['email_notify']      = $configuration->notifyEmail();
$site['bugReportMail']     = $configuration->bugReportEmail();



$dir['root']               = $configuration->siteRoot();
...
$video_ext                 = 'avi';
$MOGRIFY                   = $configuration->pathToMogrify();
$CONVERT                   = $configuration->pathToConvert();
$COMPOSITE                 = $configuration->pathToComposite();
$PHPBIN                    = $configuration->pathToPhp();

$db['host']                = $configuration->dbHostname();
$db['sock']                = $configuration->dbSocket();
$db['port']                = $configuration->dbPort();
$db['user']                = $configuration->dbUsername();
$db['passwd']              = $configuration->dbPassword();
$db['db']                  = $configuration->dbName();
