...
function getUserInfo($sId)
{
        ...
        $aUser = getArray("SELECT `ID`, `NickName`, `Sex`, `DateOfBirth`, `DescriptionMe`, `PrimPhoto` FROM `Profiles` WHERE `ID` = '" . $sId . "' LIMIT 1");
        ...
        */
        ...
        $sAge = getAge($aUser['DateOfBirth']);
        $sDesc = $aUser['DescriptionMe'];
