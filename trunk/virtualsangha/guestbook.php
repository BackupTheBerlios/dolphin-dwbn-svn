    ...
    $ret = "
			...
			<table width=\"100%\" cellpadding=\"1\" cellspacing=\"1\" border=\"0\">
				...
				<tr>
					...
					<textarea name=\"newrecord\" class=\"guestbookTextArea\" id=\"newrecord\" style=\"width:100%;\"></textarea></td>
				</tr>
				<tr>
					<td align=\"center\"><input class=\"no\" name=\"add\" type=\"submit\" value=\"". _t("_Add record") ."\"></td>
				</tr>
			</table>
			</form>\n";
	return $ret;
