...
public class RegistrationServiceImpl implements RegistrationService{
    ...
    public List<Registration> findAll(){
    	Query query = getEntityManager().createQuery( "SELECT r FROM Registration r" );
    ...
    //After clicking on the confirmattion link, change registration statuts from waiting to cofirmed
    ...
    public void cleanUp( /*@TODO int days*/ ){
    	Query query = getEntityManager().createNativeQuery( 
    			"DELETE FROM Registration WHERE regdate = '"+ new Date( (new java.util.Date()).getTime() ) + "'" );
        query.executeUpdate();        
    }    
}