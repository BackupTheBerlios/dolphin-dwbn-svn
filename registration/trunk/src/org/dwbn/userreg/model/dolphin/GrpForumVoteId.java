...
/**
 * GrpForumVoteId generated by hbm2java
 */
@Embeddable
public class GrpForumVoteId implements java.io.Serializable {

	private String userName;
	private int postId;

	public GrpForumVoteId() {
	}

	public GrpForumVoteId(String userName, int postId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GrpForumVoteId))
			return false;
		GrpForumVoteId castOther = (GrpForumVoteId) other;
