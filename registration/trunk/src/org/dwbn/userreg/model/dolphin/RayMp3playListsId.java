...
/**
 * RayMp3playListsId generated by hbm2java
 */
@Embeddable
public class RayMp3playListsId implements java.io.Serializable {

	private int fileId;
	private String owner;
	private byte order;

	public RayMp3playListsId() {
	}

	public RayMp3playListsId(int fileId, String owner, byte order) {
		this.fileId = fileId;
		this.owner = owner;
		this.order = order;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RayMp3playListsId))
			return false;
		RayMp3playListsId castOther = (RayMp3playListsId) other;
