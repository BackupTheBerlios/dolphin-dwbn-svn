...
function getAdminMenuCateg( $aCateg, $sItems, $isActiveCateg, $isOpenCateg )
{
	...
	else
	{
		...
		if( $aCateg['Link'] )
			$link = $aCateg['Link'];
		elseif( $aCateg['ID'] )
			$link = "index.php?admin_categ={$aCateg['ID']}";
		else
			$link = "index.php";
...
?>
		...
		<script type="text/javascript" language="javascript">var sRayUrl = '<?= $site['url'] . $sRayHomeDir ?>';</script>
			...
			<div class="right_menu_wrapper">
				...
				<div style="text-align:center; margin:20px;">
					<a href="http://www.expertzzz.com/" title="Experzzz - Community Software Support">
						<img src="<?= $site['url_admin'] ?>images/expertzzz.gif" alt="Expertzzz - Community Software Support" />
					</a>
				</div>
			</div>
			
			<div class="main_cont" id="main_cont" <?=($selfCategIcon) ? "style=\"background-image:url({$site['url_admin']}images/icons/$selfCategIcon);\"" : ''?>>
...
function getAdminCategIndex()
{
	...
	while( $aItem = mysql_fetch_assoc( $rItems ) )
	{
		...
		<?
                                                                                                                                                                            ...
                                                                                                                                                                            $b = '';
	...
	?>
		<table class="MsgBox" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td class="top_side"><img src="<?= "{$site['url_admin']}images/spacer.gif" ?>" /></td>
				<td class="corder"><img src="<?= "{$site['url_admin']}images/msgbox_cor_rt.png" ?>" /></td>
			</tr>
			<tr>
				<td class="left_side"><img src="<?= "{$site['url_admin']}images/spacer.gif" ?>" /></td>
				<td class="msgbox_content"><div class="msgbox_text"><?= $text ?></div></td>
				<td class="right_side"><img src="<?= "{$site['url_admin']}images/spacer.gif" ?>" /></td>
			</tr>
			<tr>
				<td class="corner"><img src="<?= "{$site['url_admin']}images/msgbox_cor_lb.png" ?>" /></td>
				<td class="bottom_side"><img src="<?= "{$site['url_admin']}images/spacer.gif" ?>" /></td>
