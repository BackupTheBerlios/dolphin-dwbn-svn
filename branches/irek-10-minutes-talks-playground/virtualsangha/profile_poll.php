...
// show polls section --------------------------------------------------------------------
	...
	while( $poll_arr = mysql_fetch_array ( $polls_num ) )
	{
		...
		$ret .= '<script language="javascript">
			poll_status_show( \'' . $uID . '\', \'poll_status_' . $uID . '\', \'' . $poll_arr['poll_status'] . '\', \'' . $status_change_to . '\' );
	    	    </script>';
		...
		<table id="questions">
			...
			<tr>
				...
				<a href="javascript:void(0);"
				  onclick="javascript: add_question_bar( 'questions_bar_cont', 'next_val', true ); return false;"><?= _t('_add answer') ?></a>
				|
